...
function InfoSection({ title, details, imdbRating }: InfoSectionProps) {
  return (
    <section className="flex flex-col gap-3 text-white">
      ...
      <p className="font-medium text-xs md:text-sm">{details}</p>
      <button className="bg-[#BE123C] py-[6px] px-4 w-max rounded-md text-white font-semibold text-xs md:text-base flex gap-2 items-center">
